...
drop policy if exists "Acesso leitura seguro" on public.data_detailed; -- ADDED
...
drop policy if exists "Acesso leitura seguro" on public.data_history; -- ADDED
...
drop policy if exists "Acesso leitura seguro" on public.data_clients; -- ADDED
...
drop policy if exists "Acesso leitura seguro" on public.data_orders; -- ADDED
...
drop policy if exists "Acesso leitura seguro" on public.data_product_details; -- ADDED
...
drop policy if exists "Acesso leitura seguro" on public.data_active_products; -- ADDED
...
drop policy if exists "Acesso leitura seguro" on public.data_stock; -- ADDED
...
drop policy if exists "Acesso leitura seguro" on public.data_innovations; -- ADDED
...
drop policy if exists "Acesso leitura seguro" on public.data_metadata; -- ADDED
...
drop policy if exists "Acesso leitura seguro" on public.goals_distribution; -- ADDED
