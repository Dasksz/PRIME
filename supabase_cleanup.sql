...
-- NOTA: Os índices 'idx_data_detailed_dtped' e 'idx_data_history_dtped' foram removidos deste script
-- porque são criados no script de otimização e são necessários para a performance.
